...
import SignatureBrands from '../category/SignatureBrands'
...
const Page = async ({ searchParams }) => {
  ...
  // Filter for top-level categories where ParentId is null
//   const topLevelCategories = getCategory.filter(
//     (category) => category.parentId === null
//   )

  return (
    <div>
      <Category masterCategory={getCategory} CategoryId={CategoryId} />
