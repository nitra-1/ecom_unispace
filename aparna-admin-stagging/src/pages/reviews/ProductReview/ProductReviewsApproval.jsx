                    ...
                    <tr key={index} className="position-relative">
                      ...
                      <td>
                        ...
                        review?.productImages.length > 0 ? (
                          <div className="position-relative">
                            <img
                              src={`${process.env.REACT_APP_IMG_URL}${_productRating_}${review?.productImages[0]}`}
                              alt="Review"
                      ...
                      <td>
                        <div className="d-flex gap-2 align-items-center">
                          <img
                            src={
                              `${process.env.REACT_APP_IMG_URL}${_productImg_}${review.productImage}` ||
        ...
        {modalImage && (
          <div className="image-modal-overlay" onClick={closeImageModal}>
            ...
            >
              ...
              <img
                src={`${process.env.REACT_APP_IMG_URL}${_productRating_}${modalImage[currentImageIndex]}`}
