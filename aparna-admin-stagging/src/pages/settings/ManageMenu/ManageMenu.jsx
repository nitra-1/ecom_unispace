...
const MainMenuForm = React.lazy(() => import('./MainMenuForm.jsx'))

const ManageMenu = ({ activeToggle }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axiosProvider({
        method: 'GET',
        endpoint: 'ManageHeaderMenu/search',
        queryString: `?searchText=${encodedSearchText(
          filterDetails?.searchText
        )}&HeaderMenuFor=${activeToggle}&pageIndex=${
