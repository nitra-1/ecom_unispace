...
const ChildMenuForm = React.lazy(() => import('./ChildMenuForm.jsx'))
const SubmenuAdd = React.lazy(() => import('./SubmenuAdd.jsx'))
...
const ManageHeader = () => {
  ...
  const handleChange = (updatedItems) => {
    ...
    if (typeof itemsToBeUpdated === 'string') {
      ...
      setChangeIdentifier({ isSequenceUpadted: false, isSequenceChanged: true })
