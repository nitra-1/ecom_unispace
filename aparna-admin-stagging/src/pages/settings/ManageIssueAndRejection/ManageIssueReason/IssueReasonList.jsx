...
const IssueReasonForm = lazy(() => import("./IssueReasonForm.jsx"));

const IssueReasonList = ({
  initialValues,
  setInitialValues,
  modalShow,
  setModalShow,
      ...
      <Table responsive className="align-middle table-list">
        <thead>
          <tr>
            ...
            <th>Issue Type</th>
            <th>Reason</th>
            {checkPageAccess(pageAccess, allPages?.manageIssueandRejection, [
              allCrudNames?.update,
              allCrudNames?.delete,
