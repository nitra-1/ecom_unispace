...
import {
  _SwalDelete,
  _exception,
} from "../../../../../lib/exceptionMessage.jsx";
import useDebounce from "../../../../../lib/useDebounce.js";

const SizeValueForm = lazy(() => import("./SizeValueForm.jsx"));
          ...
          {data?.data?.data?.length > 0
            ? data?.data?.data?.map((sizevalue) => (
                <tr key={sizevalue.id}>
                  ...
                  <td className="text-center">{sizevalue.typeName}</td>
                  {checkPageAccess(pageAccess, allPages?.size, [
                    allCrudNames?.update,
                    allCrudNames?.delete,
                  ]) && (
